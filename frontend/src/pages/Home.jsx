      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          <div className="text-center">
            ...
            <div className="text-text-secondary">Students Guided</div>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            ...
            <div className="text-text-secondary">Career Paths</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-accent-orange mb-2">
              100%
            </div>
            <div className="text-text-secondary">Free Forever</div>
          </div>
        </motion.div>
      </div>
    </div>
